...
description: Use a five-block formula to write an impactful LinkedIn About section
  tailored for Kenya.
category: linkedin
tags:
...
readingTime: 6
cover:
  src: /assets/images/blog/linkedin/about-section-in-5-blocks-who-value-proof-scope-cta-hero.webp
  alt: 'Conceptual image representing About section in 5 blocks: who, value, proof,
    scope, CTA'
  width: 1200
  height: 675
seo:
  title: LinkedIn About Section in 5 Blocks — Kenya Playbook
  description: Who, Value, Proof, Scope, CTA — a concise framework that converts views
    into leads.
