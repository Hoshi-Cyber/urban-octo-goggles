...
description: Convert projects into outcome-first caselets with metrics Kenyan employers
  value.
category: cv-tips
tags:
- Projects
...
readingTime: 6
cover:
  src: /assets/images/blog/cv-tips/projects-section-outcomes-hero.webp
  alt: Conceptual image representing Projects section that sells outcomes, not tasks
  width: 1200
  height: 675
seo:
  title: Projects Section — Outcomes, Not Tasks (Kenya)
  description: Structure short caselets with goal, method, and results in KES or %
    with links to artefacts.
