...
readingTime: 9
cover:
  src: /assets/images/blog/cv-tips/mid-career-cv-overhaul-kenya-hero.webp
  alt: 'Conceptual image representing Mid-career CV overhaul: quantify impact fast'
  width: 1200
  height: 675
seo:
  title: Mid-Career CV Overhaul — Quantify Impact Fast (Kenya)
  description: Measure cost, time, revenue, risk, quality, and scale. Convert duties
    to numbers and Kenya-specific KPIs.
