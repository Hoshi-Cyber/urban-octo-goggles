...
readingTime: 7
cover:
  src: /assets/images/blog/cv-tips/cv-skills-kenya-hero.webp
  alt: 'Conceptual image representing Skills matrix: hard vs soft skills recruiters
    scan'
  width: 1200
  height: 675
seo:
  title: CV Skills Matrix for Kenya — Hard vs Soft Skills
  description: Targeted skills increase match scores and interview rates. Map core
    hard and soft skills to role families.
